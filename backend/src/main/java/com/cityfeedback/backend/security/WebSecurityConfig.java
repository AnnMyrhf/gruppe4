...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(requests -> requests
                ...
                .requestMatchers("mitarbeiter/dashboard", "/buerger/dashboard/**", "/buerger-anmelden/**", "/buerger-registrieren/**", "/mitarbeiter-registrieren/**", "/mitarbeiter-anmelden/**", "/h2/**").permitAll()
