...
public class BackendApplication {
    ...
    @Bean
    CommandLineRunner commandLineRunner(MitarbeiterRepository mitarbeiterRepository, BuergerRepository buergerRepository, BeschwerdeRepository beschwerdeRepository, MitarbeiterService mitarbeiterService, PasswordEncoder passwordEncoder, BenachrichtigungsRepository benachrichtigungsRepository){
        return args -> {
            // Leere Liste fuer Beschwerden
            final List<Beschwerde> beschwerden = new ArrayList<>();
            //final List<Benachrichtigung> benachrichtigungen = new ArrayList<>();
